...
public final class HomeListFragment_MembersInjector implements MembersInjector<HomeListFragment> {
  ...
  public HomeListFragment_MembersInjector(
  ...
  public static MembersInjector<HomeListFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<HomeContract.Presenter> mPresenterProvider) {
    return new HomeListFragment_MembersInjector(childFragmentInjectorProvider, mPresenterProvider);
  }

  @Override
  public void injectMembers(HomeListFragment instance) {
  ...
  public static void injectMPresenter(
      HomeListFragment instance, HomeContract.Presenter mPresenter) {
